...
class Dj:
    ...
    def read_from_csv(cls):
        ...
        with open(FILENAME) as file:
            ...
            djs = [cls(**payload) for payload in reader]
    ...
    def update_file_csv(cls):
        ...
        formatted_djs = [dj.as_dict for dj in cls.djs]
        with open(FILENAME, "w") as file:
            writer = csv.DictWriter(file, formatted_djs[0].keys(), dialect='unix')
            writer.writeheader()
            writer.writerows(formatted_djs )
